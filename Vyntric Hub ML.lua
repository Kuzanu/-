...
local Window = Library:CreateWindow{
    Title = "Vyntric Hub | Game: Muscle Legends | Version [v.5.8.6]",
    SubTitle = "by ttvkaiser & Exv_",
    TabWidth = 160,
...
Library:Notify{
    Title = "Welcome to Vyntric Hub",
    Content = "Vyntric Hub supports 1 games!",
    SubContent = "This game is muscle legends and currently in in version 5.8.6!", -- Optional
            ...
            Buttons = {
                {
                    Title = "Confirm",
                    Callback = function()
                        local link = "https://discord.gg/G6q7FJCyc8"
                        setclipboard(link)
